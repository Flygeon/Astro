...
description: 从扫码登录到歌单云盘播放，本以为一晚上搞定，结果被「HTTP 200 但 0 字节」的诡异空响应折腾了整整六个小时。RSA
  填充、PEM 换行、AES 层序……最后真凶是一行没写的代码。
tags:
  - 网易云
  - Tauri
  - RUST
...
pinned: false
---
事情是这样的，我原先开发的多媒体库应用 LumiLuna 重构了（[https://github.com/Flygeon/LumiLuna-Next](https://github.com/Flygeon/LumiLuna-Next)），重构后我就添加了接入metingAPI播放在线音乐，但这玩意有个痛点：metingAPI只能读取歌单前200首，而且还得手动导入歌单，非常滴麻烦，那么，是时候加入网易云登录系统了，当时我的想法很天真：直接找现有的开源接口解密项目，照着抄就行了。结果这一抄，就是六个小时的噩梦。
